...
__main			PROC
                LDR R0,=array
;---------------------code tai day--------------------------
  ;bai 6: y = 3*x^3-7*x^2+10x-11 gia su x bang 2 =>> R1, y=>> R2
                LDR R1, =3     ; gan x cho thang R1
                MUL R3, R1, R1 ; tinh x^2
                MUL R3, R1, R3 ; tinh x^3
                MOV R4, #3     ; gan 3 cho thanh ghi R4
                MUL R2, R3, R4 ; tinh 3*x^3
                MUL R3, R1, R1 ; tinh x^2
                MOV R4, #7     ; gan 7 cho thanh R4
                MUL R3, R4, R3 ; tinh 7*x^2
                SUB R2, R2, R3 ; tinh 3x^3-7x^2
                MOV R4, #10    ; gan 10 cho thanh ghi R4
                MUL R3, R1, R4 ; tinh 10x
                ADD R2, R2, R3 ; tinh 3x^3-7x^2+10x
                SUB R2,    R2, #11;tinh 3x^3-7x^2+10x-11
;--------------------code tai dau -------------------------								
